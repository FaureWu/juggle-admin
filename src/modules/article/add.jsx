      ...
      >
        ...
        >
          <Select
            value={`${data.cate}`}
            onChange={value =>
              this.inputChange({ target: { name: 'cate', value } })}
          >
            {cates
              .map(cate => (
                <Select.Option
        ...
        >
          ...
          >
            {Object.keys(ARTICLE_STATUS)
              .map(key => (
                <Select.Option
                  key={`ARTICLE_STATUS_${ARTICLE_STATUS[key].value}`}
                  value={`${ARTICLE_STATUS[key].value}`}
                >{ARTICLE_STATUS[key].label}</Select.Option>
              ))}
          </Select>
        </Form.Item>
        <Form.Item
